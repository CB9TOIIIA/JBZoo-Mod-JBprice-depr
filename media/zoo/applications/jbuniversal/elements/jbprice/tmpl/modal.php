...
//                if(window.location.href.indexOf("zapravcvet") > -1) {

//                    consile.log(window.location.href.indexOf("zapravcvet"));

////                    alert("your url contains the name zapravcvet");
...
//++++ stop insertg by woojin for radio input select or change quantity++++
                ...
                var price_quantity = parent.price_quantity;
